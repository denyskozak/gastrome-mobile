    ...
    >
      ...
      >
        <VideoPlayer
          ...
          resizeMode="cover"
          progressLineBottomPosition={isListening ? 0 : Spaces.xxlarge + Spaces.small}
          onLoaded={() => {
        ...
        {!hideButtons && (
          <Animated duration={1000} name="SlideInLeft" outName="SlideOutLeft" style={styles.backButtonContainer}>
            ...
            {duration && !isTimerActive ? <TimerButton onPress={onStartTimePress} duration={duration} /> : null}
        ...
        <Animated style={styles.textContainer}>
          ...
          <Pressable style={styles.textHideIcon} onPress={() => setIsTextHidden(!isTextHidden)}>
            <Icon name={isTextHidden ? 'eye-outline' : 'eye-off-outline'} color={Colors.black} size={Spaces.large}/>
          </Pressable>
